        ...
        <div className="row gy-5 align-items-center">
            ...
            <div className="banner-content pe-md-4">
              <div className="flex-align gap-8 mb-16" data-aos="fade-down">
                ...
                <h5 className="text-main-600 mb-0">
                  Welcome to Bartika Lifeprint Academy
                </h5>
              </div>
              ...
              <p className="text-neutral-500 text-line-4 wow bounceInUp">
                Are you feeling lost, stuck, or questioning your true identity?
                At Bartika Lifeprint Academy, we help women break free from
                self-doubt and rediscover their authentic selves through
                Fingerprint Personality Decoding and Mindfulness.
              </p>
          ...
          <div className="col-xl-6">
            <div className="banner-thumb position-relative">
              <img
                src="assets/images/photos/Untitled  (602 x 763 px).png"
                alt=""
